...
def user_interaction():
    ...
    while (True):
        ...
        if select_mode == 1:
            ...
            filter_words = input(
                'Введите ключевые слова для фильтрации вакансий \033[32mнапример Москва\033[0m: ').split()
            salary_range = input(
                'Введите диапазон зарплат \033[32mнапример 10000-15000\033[0m: ')  # Пример: 100000-150000
